...
(function (root, factory) {
  ...
  function until(_this__u8e3s4, to) {
    if (to <= IntCompanionObject_getInstance().MIN_VALUE)
      return Companion_getInstance_1().e_1;
  ...
  function downTo(_this__u8e3s4, to) {
    return Companion_getInstance_2().f(_this__u8e3s4, to, -1);
  }
  ...
  protoOf(Companion).l = function (c, other) {
    if (!(c.h() === other.h()))
      return false;
  ...
  protoOf(ArrayAsCollection).i = function () {
    ...
    var tmp0_isEmpty = this.m_1;
    tmp$ret$0 = tmp0_isEmpty.length === 0;
    return tmp$ret$0;
  };
  protoOf(ArrayAsCollection).b = function () {
    return arrayIterator(this.m_1);
  };
  ...
  function Default() {
    ...
    Random.call(this);
    this.p_1 = defaultPlatformRandom();
  }
  protoOf(Default).q = function (bitCount) {
    return this.p_1.q(bitCount);
  };
  protoOf(Default).r = function () {
    return this.p_1.r();
  };
  ...
  protoOf(Random).r = function () {
    return doubleFromParts(this.q(26), this.q(27));
  };
  ...
  function XorWowRandom(x, y, z, w, v, addend) {
    ...
    var tmp0_require = !((this.t_1 | this.u_1 | this.v_1 | this.w_1 | this.x_1) === 0);
  ...
  protoOf(XorWowRandom).o = function () {
    var t = this.t_1;
    t = t ^ (t >>> 2 | 0);
    this.t_1 = this.u_1;
    this.u_1 = this.v_1;
    ...
    this.x_1 = t;
    var tmp0_this = this;
    tmp0_this.y_1 = tmp0_this.y_1 + 362437 | 0;
    return t + this.y_1 | 0;
  };
  protoOf(XorWowRandom).q = function (bitCount) {
    return takeUpperBits(this.o(), bitCount);
  };
  ...
  function IntProgressionIterator(first, last, step) {
    ...
    this.h1_1 = step;
    this.i1_1 = last;
    this.j1_1 = this.h1_1 > 0 ? first <= last : first >= last;
    this.k1_1 = this.j1_1 ? first : this.i1_1;
  }
  ...
  protoOf(IntProgressionIterator).o = function () {
    ...
    if (value === this.i1_1) {
      ...
      var tmp0_this = this;
      tmp0_this.k1_1 = tmp0_this.k1_1 + this.h1_1 | 0;
    }
    return value;
  };
  ...
  protoOf(Companion_2).f = function (rangeStart, rangeEnd, step) {
  ...
  function substring(_this__u8e3s4, range) {
    return toString_1(charSequenceSubSequence(_this__u8e3s4, range.c1(), range.g1() + 1 | 0));
  }
  ...
  function calcNext($this) {
    if ($this.u1_1 < 0) {
      ...
      if ($this.x1_1.a2_1 > 0) {
        var tmp0_this = $this;
        tmp0_this.w1_1 = tmp0_this.w1_1 + 1 | 0;
        tmp_0 = tmp0_this.w1_1 >= $this.x1_1.a2_1;
      } else {
        tmp_0 = false;
      }
      if (tmp_0) {
        ...
        tmp = $this.u1_1 > charSequenceLength($this.x1_1.y1_1);
      }
      if (tmp) {
        $this.v1_1 = numberRangeToNumber($this.t1_1, get_lastIndex($this.x1_1.y1_1));
        $this.u1_1 = -1;
      } else {
        var match = $this.x1_1.b2_1($this.x1_1.y1_1, $this.u1_1);
        if (match == null) {
          $this.v1_1 = numberRangeToNumber($this.t1_1, get_lastIndex($this.x1_1.y1_1));
          $this.u1_1 = -1;
        } else {
          ...
          $this.v1_1 = until($this.t1_1, index);
          $this.t1_1 = index + length | 0;
          $this.u1_1 = $this.t1_1 + (length === 0 ? 1 : 0) | 0;
        }
      }
      $this.s1_1 = 1;
    }
  ...
  function DelimitedRangesSequence$iterator$1(this$0) {
    this.x1_1 = this$0;
    this.s1_1 = -1;
    this.t1_1 = coerceIn(this$0.z1_1, 0, charSequenceLength(this$0.y1_1));
    this.u1_1 = this.t1_1;
    this.v1_1 = null;
    this.w1_1 = 0;
  }
  ...
  function DelimitedRangesSequence(input, startIndex, limit, getNextMatch) {
    this.y1_1 = input;
    this.z1_1 = startIndex;
    this.a2_1 = limit;
    this.b2_1 = getNextMatch;
  }
  ...
  protoOf(Pair).e2 = function () {
    return this.c2_1;
  };
  protoOf(Pair).f2 = function () {
    return this.d2_1;
  };
  ...
  protoOf(AbstractMutableList).equals = function (other) {
    ...
    if (!(!(other == null) ? isInterface(other, List) : false))
      return false;
    return Companion_getInstance().l(this, other);
  };
  ...
  function rangeCheck($this, index) {
    ...
    Companion_getInstance().j(index, $this.h());
    tmp$ret$0 = index;
    return tmp$ret$0;
  }
  function insertionRangeCheck($this, index) {
    ...
    Companion_getInstance().k(index, $this.h());
    tmp$ret$0 = index;
    return tmp$ret$0;
  }
  ...
  protoOf(ArrayList).u2 = function (index, element) {
    ...
    var tmp$ret$0;
    // Inline function 'kotlin.apply' call
    var tmp0_apply = this.p1_1[index];
    // Inline function 'kotlin.contracts.contract' call
    // Inline function 'kotlin.collections.ArrayList.set.<anonymous>' call
    this.p1_1[index] = element;
  ...
  protoOf(StringBuilder).i2 = function (startIndex, endIndex) {
    var tmp$ret$1;
    // Inline function 'kotlin.text.substring' call
  ...
  protoOf(StringBuilder).m1 = function (value) {
    var tmp0_this = this;
    tmp0_this.r1_1 = tmp0_this.r1_1 + new Char(value);
    return this;
  };
  protoOf(StringBuilder).a = function (value) {
    var tmp0_this = this;
    tmp0_this.r1_1 = tmp0_this.r1_1 + toString_0(value);
    return this;
  };
  ...
  function implement(interfaces) {
    ...
    while (inductionVariable < last) {
      ...
      if (!(iidImask == null)) {
        masks.push(iidImask);
        currentSize = Math.max(currentSize, iidImask.g3_1.length);
      }
  ...
  protoOf(BitMask).h3 = function (possibleActiveBit) {
    var numberIndex = possibleActiveBit >> 5;
    if (numberIndex > this.g3_1.length)
      return false;
    var positionInNumber = possibleActiveBit & 31;
    var numberWithSettledBit = 1 << positionInNumber;
    return !((this.g3_1[numberIndex] & numberWithSettledBit) === 0);
  };
  function implement$lambda($tmp) {
    return function (acc, it) {
      return $tmp >= it.g3_1.length ? acc : acc | it.g3_1[$tmp];
    };
  }
  ...
  protoOf(arrayIterator$1).d = function () {
    ...
    if (!(this.i3_1 === this.j3_1.length)) {
      var tmp0_this = this;
      var tmp1 = tmp0_this.i3_1;
      tmp0_this.i3_1 = tmp1 + 1 | 0;
      tmp = this.j3_1[tmp1];
    } else {
  ...
  protoOf(Long).s3 = function () {
    return this.t3().q3(new Long(1, 0));
  };
  protoOf(Long).t3 = function () {
    return new Long(~this.o3_1, ~this.p3_1);
  };
  ...
  function add(_this__u8e3s4, other) {
    _init_properties_longjs_kt__tqrzid();
    var a48 = _this__u8e3s4.p3_1 >>> 16 | 0;
    var a32 = _this__u8e3s4.p3_1 & 65535;
    var a16 = _this__u8e3s4.o3_1 >>> 16 | 0;
    var a00 = _this__u8e3s4.o3_1 & 65535;
    var b48 = other.p3_1 >>> 16 | 0;
    var b32 = other.p3_1 & 65535;
    var b16 = other.o3_1 >>> 16 | 0;
    var b00 = other.o3_1 & 65535;
    var c48 = 0;
    var c32 = 0;
    var c16 = 0;
    var c00 = 0;
  ...
  function shiftLeft(_this__u8e3s4, numBits) {
    ...
    if (numBits_0 === 0) {
      ...
      if (numBits_0 < 32) {
        return new Long(_this__u8e3s4.o3_1 << numBits_0, _this__u8e3s4.p3_1 << numBits_0 | (_this__u8e3s4.o3_1 >>> (32 - numBits_0 | 0) | 0));
      } else {
        return new Long(0, _this__u8e3s4.o3_1 << (numBits_0 - 32 | 0));
      }
    }
  }
  function shiftRight(_this__u8e3s4, numBits) {
    ...
    if (numBits_0 === 0) {
      ...
      if (numBits_0 < 32) {
        return new Long(_this__u8e3s4.o3_1 >>> numBits_0 | 0 | _this__u8e3s4.p3_1 << (32 - numBits_0 | 0), _this__u8e3s4.p3_1 >> numBits_0);
      } else {
        return new Long(_this__u8e3s4.p3_1 >> (numBits_0 - 32 | 0), _this__u8e3s4.p3_1 >= 0 ? 0 : -1);
      }
    }
  }
  function toNumber(_this__u8e3s4) {
    _init_properties_longjs_kt__tqrzid();
    return _this__u8e3s4.p3_1 * 4.294967296E9 + getLowBitsUnsigned(_this__u8e3s4);
  }
  function equalsLong(_this__u8e3s4, other) {
    _init_properties_longjs_kt__tqrzid();
    return _this__u8e3s4.p3_1 === other.p3_1 ? _this__u8e3s4.o3_1 === other.o3_1 : false;
  }
  ...
  function isNegative(_this__u8e3s4) {
    _init_properties_longjs_kt__tqrzid();
    return _this__u8e3s4.p3_1 < 0;
  }
  function isZero(_this__u8e3s4) {
    _init_properties_longjs_kt__tqrzid();
    return _this__u8e3s4.p3_1 === 0 ? _this__u8e3s4.o3_1 === 0 : false;
  }
  function isOdd(_this__u8e3s4) {
    _init_properties_longjs_kt__tqrzid();
    return (_this__u8e3s4.o3_1 & 1) === 1;
  }
  ...
  function getLowBitsUnsigned(_this__u8e3s4) {
    _init_properties_longjs_kt__tqrzid();
    return _this__u8e3s4.o3_1 >= 0 ? _this__u8e3s4.o3_1 : 4.294967296E9 + _this__u8e3s4.o3_1;
  }
