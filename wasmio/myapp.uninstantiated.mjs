...
export async function instantiate(skiaPromise, imports={}, runInitializer=true) {
    ...
    try {
      ...
      if (isBrowser) {
          ...
          const importObjectBr = {
              js_code,
              'skia': Module['asm'],
          };

          wasmInstance = await WebAssembly.instantiate(m, importObjectBr);
      }
    } catch (e) {
